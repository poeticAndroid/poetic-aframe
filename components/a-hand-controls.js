...
delete AFRAME.components["hand-controls"]
...
registerComponent('hand-controls', {
  ...
  tick: function (time, delta) {
    var mesh = this.handEntity.getObject3D('mesh');
  ...
  update: function (previousHand) {
    ...
    var el = this.el;
    let handEntity = this.data.handEntity || el
    ...
    if (hand !== previousHand) {
      ...
      this.loader.load(handmodelUrl, function (gltf) {
        ...
        handEntity.setObject3D('mesh', mesh);
  ...
  remove: function () {
    this.handEntity.removeObject3D('mesh');
  },
